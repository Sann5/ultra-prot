...
prot = pd.read_csv(path_to_file, usecols =[i for i in cols if 'TSCP_DIA_SingleCell' in i], sep='\t')
var_annotation = pd.read_csv(path_to_file, index_col = 'Genes', usecols = ['Genes'], sep='\t')
